...
const TableEditor = () => {
	...
	return (
		<div id="tables" className="bg-custom-dark rounded-5 p-3 my-3">
			<div className="row">
				...
				<div className="col-12 col-lg-6 col-xl-4">
					<p className="fs-4 bg-custom-lightdark mx-5 text-center fw-bold my-3 py-2 rounded-5">Table style</p>
				...
				<div className="col-12 col-lg-6 col-xl-4">
					<p className="fs-4 bg-custom-lightdark mx-5 text-center fw-bold my-3 mt-5 mt-lg-3 py-2 rounded-5">
						Table Row style
					</p>
					<div className="d-flex flex-column align-items-center mb-4">
						<div className="d-flex align-items-center my-3">
					...
					<div className="margin-code-1">
						<GenericPreview style={trStyle} classType="TableRow" />
					</div>
				</div>
				<div className="col-12 col-xl-4">
					<p className="fs-4 bg-custom-lightdark mx-5 text-center fw-bold my-3 mt-5 mt-xl-3 py-2 rounded-5">
						Table cells style
					</p>
					<div className="d-flex flex-column align-items-center mb-4">
						<div className="d-flex align-items-center my-3">
